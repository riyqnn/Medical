...
const Sidebar = () => {
  const menuItems = [
    ...
    { id: 'appointments', label: 'Appointments', icon: CalendarDateRangeIcon, to: '/appointments' },
    { id: 'patients', label: 'Patients', icon: UsersIcon, to: '/patients' },
    { id: 'doctors', label: 'Doctors', icon: UserCircleIcon, to: '/doctors' },
