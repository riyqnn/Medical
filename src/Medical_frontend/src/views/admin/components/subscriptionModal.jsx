...
export const SubscriptionModal = ({ isOpen, onClose, hospitalName, onSubscribe }) => {
  ...
  const plans = [
    {
      ...
      features: ['Hospital Registration', 'All doctor profiles', 'Basic Features', 'Monthly Billing'],
      popular: false
    },
    {
      id: 'yearly',
      ...
      features: ['Everything in Monthly', 'All Features', 'Annual Billing', 'Save 58%'],
      popular: true
    },
    {
      id: 'lifetime',
      ...
      features: ['Everything in Yearly', 'Lifetime updates', 'One-time Payment', 'Best Value'],
      popular: false
    }
  ];
        ...
        <div className="p-3 sm:p-4 border-b border-gray-200 flex-shrink-0">
          <div className="flex items-center justify-between">
            <div className="flex-1 min-w-0 pr-2">
              <h2 className="text-lg sm:text-xl font-bold text-gray-900 truncate">Activate Hospital Access</h2>
        ...
        <div className="p-3 sm:p-4 overflow-y-auto flex-1">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4 sm:mb-6">
            {plans.map((plan) => (
              ...
              >
                ...
                {/* Show description and features only for selected plan */}
                {selectedPlan === plan.id && (
                ...
                {/* Show feature count for non-selected plans */}
                {selectedPlan !== plan.id && (
          ...
          <div className="mt-4 sm:mt-6 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0">
            ...
            >
              ...
              <span>Activate {plans.find(p => p.id === selectedPlan)?.name}</span>
            </button>
          </div>
        </div>
      </div>
